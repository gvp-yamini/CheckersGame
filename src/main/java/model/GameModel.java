...
import main.java.model.GameModel.IMakePlayer;
...
public final class GameModel implements IModel {
	...
	public GameModel(int nRows, int nCols) {
		 boardModel = new CheckersBoard(nRows, nCols);
	}
	...
	{ //user makes move using requestor
		public void setTokenAt(final int row, final int col, final int player, final IRejectCommand rejectCommand) 
		{
			...
			new IBoardStatusVisitor() 
			{
				...
				{
					viewManager.win(0); return null; // Tell view
				}
				public Object player1WonCase(IBoardModel host,Object param) 
				{
					viewManager.win(1); return null; // Tell view
				}
				public Object drawCase(IBoardModel host, Object param) 
				{
					viewManager.draw(); return null; // Tell view
				}
	...
	public List<Object> getPlayers() {
		...
		playerList.add(new IMakePlayer() {
			...
			public String toString() {
				return "Computer player with random move";
			}
		});
